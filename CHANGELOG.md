...
### Added
- Network reconciliation to automatically reconnect gateway to function networks on startup and periodically
- New environment variables `RECONCILE_FUNCTION_NETWORKS` and `RECONCILE_INTERVAL_SECONDS`
